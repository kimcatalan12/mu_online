...
<html lang="en">
  ...
  <body>
    <header>
      <nav class="bg-body-tertiary m-3 navbar navbar-expand px-3 rounded-4">
          ...
          <div class="gap-2 hstack">
            ...
            <ul class="align-items-center hstack mb-0 mb-lg-0 ms-auto ps-0" id="nav-menu">
              <div class="align-items-center navbar-nav">
                ...
                <li class="nav-item">
                  <a class="link-offset-3 nav-link" href="#"><span class="fourth_color fs-4">REGISTER</span></a>
                </li>
                <li class="nav-item">
            ...
            <a class="btn rounded-4 thirdb_color" href="#"><span class="fourth_color fs-4">LOGIN</span></a>
          </div>
        </div>
      </nav>
    </header>
    <main class="container">
      <section class="carousel_section carousel-fade" style="margin-bottom: 7rem;">
        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="3000">
              <img src="image/c_dk.png" class="d-block w-100" alt="carousel image">
              <div class="carousel-caption col-md-5 col-lg-4 text-start">
                <p class="fs-1 third_color">Rorem ipsum </p>
                <p class="fs-2 fourth_color">Rorem ipsum </p>
                <p class="fs-6 fourth_color">Sorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur tempus urna at turpis condimentum lobortis. Ut commodo efficitur neque.</p>
              </div>
            </div>
            <div class="carousel-item" data-bs-interval="3000">
              <img src="image/c_elf.png" class="d-block w-100" alt="carousel image">
              <div class="carousel-caption col-md-5 col-lg-4 text-start">
                <p class="fs-1 third_color">Rorem ipsum </p>
                <p class="fs-2 fourth_color">Rorem ipsum </p>
                <p class="fs-6 fourth_color">Sorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur tempus urna at turpis condimentum lobortis. Ut commodo efficitur neque.</p>
            ...
            <div class="carousel-item" data-bs-interval="3000">
              <img src="image/c_wiz.png" class="d-block w-100" alt="carousel image">
              <div class="carousel-caption col-md-5 col-lg-4 text-start">
                <p class="fs-1 third_color">Rorem ipsum </p>
                <p class="fs-2 fourth_color">Rorem ipsum </p>
                <p class="fs-6 fourth_color">Sorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur tempus urna at turpis condimentum lobortis. Ut commodo efficitur neque.</p>
    ...
    <footer class="container">
      ...
      <div class="d-flex flex-column flex-sm-row gap-3 justify-content-between mb-4">
        ...
        <div class="gap-3 hstack">
          ...
          <a href="#" class="second_color"><i class="fa-brands fa-square-facebook fa-2xl "></i></a>
          <a href="#" class="second_color"><i class="fa-brands fa-square-twitter fa-2xl"></i></a>
          <a href="#" class="second_color"><i class="fa-brands fa-square-youtube fa-2xl"></i></a>
        </div>
      </div>
    </footer>
